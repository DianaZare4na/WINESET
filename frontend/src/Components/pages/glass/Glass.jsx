...
import im from "./gl.png";
function Glass({putToBasket, putToFavorite}){
  
   const [product, setProduct] = useState({});
   const [isLoad, setIsLoad] = useState(false);

   useEffect( () => {
         fetch("/api/product/glass")
               .then(res => {
                  console.log(res);
                  return res.json()})
               .then(res => {
                  ...
                  <section className="col-12">
                     ...
                     <div className="page-gifts-img mim"><img src={im} alt="..."/></div>
                        ...
                        <div className="bacground-div-text-man bacground-div-text-man-down">
                              ...
                              <h2 className="glasses-сandles glasses-сandles-down">RIEDEL WING’S<br/> WINE SET</h2>
