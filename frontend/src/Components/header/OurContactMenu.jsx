            ...
            <div className="modal-content ">
               ...
               <div className="modal-body modal-body-our-contact">
                  ...
                  <div className="modal-body-our-contact-social">
                     <a href="https://www.instagram.com/dianazarechnaia/"><img src={inst} alt="" /></a>
                     <a href="https://t.me/DianaZariechna"><img src={tel} alt="" /></a>
                     <a href="https://www.facebook.com/diana.zariechnaya"><img src={fac} alt="" /></a>
                  </div>
               </div>
               <div className="modal-footer modal-body-our-contact-modal-footer">
               <button type="button" className="btn btn-primary"><Link to="/">Узнать больше</Link></button>
               </div>
            </div>
         </div>
      </div>
